    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class="lead">Thank you for registering with VirtuShop. You are now part of our community.</p>
                <p class="text-muted">You can now explore our products and enjoy a seamless shopping experience.</p>
